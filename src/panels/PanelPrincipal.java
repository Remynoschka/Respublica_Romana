...
public abstract class PanelPrincipal extends MouseOverArea {
	...
	public PanelPrincipal(GUIContext container, GameState etat)
			throws SlickException {
		super(container, new Image(0, 0), 0, PanelInfosFaction.HAUTEUR_BANDEAU,
				container.getWidth() - PanelInfosFaction.LARGEUR, container
						.getHeight()
