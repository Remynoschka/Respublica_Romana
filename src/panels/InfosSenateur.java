...
public class InfosSenateur extends MouseOverArea {
	...
	public void render(GUIContext container, Graphics g) {
		...
		g.drawString("MIL : " + senateur.getValeurMilitaire(), getX() + 5,
				getY() + 20);
		g.drawString("LOY : " + senateur.getLoyaute(), getX() + 5, getY() + 35);
		g.drawString("POP : " + senateur.getPopularite(), getX() + 5,
				getY() + 50);
		g.drawString("INF : " + senateur.getInfluence(), getX() + 5,
				getY() + 65);
		g.drawString("CHE : " + senateur.getNbChevaliers(), getX() + 5,
				getY() + 80);
